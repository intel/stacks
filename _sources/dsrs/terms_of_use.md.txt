...
<center>Data Services Reference Stack</center>
<center>Terms of Use</center><p>


The Data Services Reference Stack is made up of many pieces of software created by a range of individuals, teams, and companies. Data Services Reference Stack is a collective work, and each piece of software within the work has its own license (referred to below as the Compilation). Your use of each piece of software is governed by the terms of its accompanying license. You should confirm beforehand that when you use any part of the Data Services Reference Stack that its use is in compliance with the licenses involved. Redistribution of parts or the whole of the Data Services Reference Stack may require you to comply with additional license requirements.

The list of licenses used in the Data Services Reference Stack are contained in the following link: https://download.clearlinux.org/current/licenses
