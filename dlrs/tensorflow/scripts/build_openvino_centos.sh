...
CMAKE_ARGS="$CMAKE_ARGS -DENABLE_PYTHON=ON -DPYTHON_EXECUTABLE=$(command -v python) -DPYTHON_LIBRARY=/usr/lib64/libpython3.6m.so -DPYTHON_INCLUDE_DIR=/usr/include/python3.6m"
cmake $CMAKE_ARGS ..
make -j "$N_JOBS"
