...
# install dependencies for tensorflow build
  pip install pip six wheel "numpy<1.19.0" setuptools mock "future>=0.17.1"
...
apply_patch() {
  ...
  #echo "Adding fix for: https://github.com/clearlinux/distribution/issues/1151"
