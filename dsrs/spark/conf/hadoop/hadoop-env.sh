...
# export HADOOP_OPTIONAL_TOOLS="hadoop-aliyun,hadoop-azure-datalake,hadoop-kafka,hadoop-openstack,hadoop-aws,hadoop-azure"
...
export HDFS_NAMENODE_USER="analytics"
export HDFS_DATANODE_USER="analytics"
export HDFS_SECONDARYNAMENODE_USER="analytics"
export YARN_RESOURCEMANAGER_USER="analytics"
export YARN_NODEMANAGER_USER="analytics"
